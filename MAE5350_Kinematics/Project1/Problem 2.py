...
def function(r1, r2, r3, zeta1, zeta2, zeta3, alpha2, alpha3):
    ...
    if beta31 == alpha2 or beta31 == alpha3:
        beta3 = beta32
    else:
        beta3 = beta31
...
beta2, beta3 = function(R1,R2,R3,zeta1,zeta2,zeta3,alpha2,alpha3)
gamma2, gamma3 = function(R1,R2,R3,zeta1,zeta2,zeta3,alpha2,alpha3)
